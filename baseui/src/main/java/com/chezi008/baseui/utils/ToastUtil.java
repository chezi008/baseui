 ...
 */
package com.chezi008.baseui.utils;
...
public class ToastUtil {
    ...
    public static void showMessage(Fragment fragment, final String msg) {
        showMessage(fragment.getActivity(), msg, Toast.LENGTH_LONG);
    }
